...
function generateAvatar() {
  ...
  const avatars= [
    'https://avataaars.io/?avatarStyle=Circle&topType=ShortHairDreads02&accessoriesType=Prescription01&hairColor=SilverGray&facialHairType=BeardMajestic&facialHairColor=BrownDark&clotheType=CollarSweater&clotheColor=Gray01&eyeType=Wink&eyebrowType=RaisedExcited&mouthType=Twinkle&skinColor=Tanned',
    'https://avataaars.io/?avatarStyle=Circle&topType=LongHairBun&accessoriesType=Blank&hairColor=BrownDark&facialHairType=BeardLight&facialHairColor=Brown&clotheType=BlazerShirt&clotheColor=Blue03&eyeType=Default&eyebrowType=DefaultNatural&mouthType=ScreamOpen&skinColor=Yellow',
    'https://avataaars.io/?avatarStyle=Circle&topType=LongHairNotTooLong&accessoriesType=Kurt&hairColor=SilverGray&facialHairType=MoustacheMagnum&facialHairColor=Auburn&clotheType=BlazerShirt&clotheColor=PastelYellow&eyeType=Cry&eyebrowType=SadConcerned&mouthType=Default&skinColor=Yellow',
    'https://avataaars.io/?avatarStyle=Circle&topType=WinterHat1&accessoriesType=Round&hatColor=Red&hairColor=BlondeGolden&facialHairType=BeardMedium&facialHairColor=Red&clotheType=ShirtVNeck&clotheColor=PastelRed&eyeType=Dizzy&eyebrowType=Angry&mouthType=Eating&skinColor=Black',
    'https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortCurly&accessoriesType=Prescription02&hatColor=Blue03&hairColor=Blonde&facialHairType=MoustacheFancy&facialHairColor=Auburn&clotheType=ShirtVNeck&clotheColor=PastelGreen&eyeType=WinkWacky&eyebrowType=DefaultNatural&mouthType=Grimace&skinColor=Yellow'
  ];
            ...
            if (user && user.id) {
              CometChatWidget.init({
                ...
                CometChatWidget.login({uid: user.id}).then((loggedInUser) => {
                  ...
                  window.location.href = '../ChatChatMe-main/index.html';
                });
              }, error => {
                //Check the reason for error and take appropriate action.
              });
